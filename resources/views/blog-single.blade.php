        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <div class="blog-author clearfix" data-aos="fade-up">
              <img src="{{('img/blog-author.jpg')}}" class="rounded-circle float-left" alt="">
              <h4>Jane Smith</h4>
            ...
            <div class="blog-comments" data-aos="fade-up">
              ...
              <div id="comment-2" class="comment clearfix">
                ...
                <div id="comment-reply-1" class="comment comment-reply clearfix">
                  ...
                  <div id="comment-reply-2" class="comment comment-reply clearfix">
                    <img src="{{('img/comments-4.jpg')}}" class="comment-img  float-left" alt="">
              ...
              <div id="comment-3" class="comment clearfix">
                <img src="{{('img/comments-5.jpg')}}" class="comment-img  float-left" alt="">
              ...
              <div id="comment-4" class="comment clearfix">
                <img src="{{('img/comments-6.jpg')}}" class="comment-img  float-left" alt="">
